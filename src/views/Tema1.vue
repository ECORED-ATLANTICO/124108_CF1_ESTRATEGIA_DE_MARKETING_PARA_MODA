...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-center.mb-5.justify-content-center
      .col-lg-8(data-aos="fade-right").custom-tabs
        TabsA.color-acento-botones.mb-4.mb-lg-0
          .tarjeta.p-4.h-100.d-flex.align-items-center.bg-terciario-t20(titulo="Concepto 1")
            p.mb-4.mb-lg-0 La mercadotecnia (marketing o mercadeo) es #[strong la actividad, conjunto de instituciones y procesos para crear, comunicar, entregar e intercambiar ofertas que tienen valor para los consumidores, clientes y socios]. Cabe mencionar que antes se concebía el mercadeo solo en el marco de las ventas (American Marketing Asociation, 2017).

          .tarjeta.p-4.h-100.d-flex.align-items-center.bg-terciario-t20(titulo="Concepto 2")
            p.mb-4.mb-lg-0 Según  Philip Kotler y Gary Armstrong (2013), #[strong "el marketing es un proceso social y directivo mediante el que los individuos y las organizaciones obtienen lo que necesitan y desean a través de la creación y el intercambio de valor con los demás”]. (p.5).
          ...
          .tarjeta.p-4.h-100.d-flex.align-items-center.bg-terciario-t20(titulo="Concepto 4")
            p.mb-4.mb-lg-0 De acuerdo con Solomon y Stuart (como se citó en Rosenstiehl, 2016 ), #[strong “el concepto de marketing implica que, al identificar las necesidades de los consumidores y al suministrar productos que satisfagan estas necesidades, la organización asegura su rentabilidad a largo plazo”] (2001,p.7)
    ...
    .cajon.color-acento-contenido.p-4.mb-4.mb-lg-5
      p.mb-0 Las últimas definiciones tienen elementos comunes en relación con la importancia organizacional, comercial, y se amplía a la esfera social, explicitando el papel cada vez más preponderante que el marketing representa en la sociedad.
